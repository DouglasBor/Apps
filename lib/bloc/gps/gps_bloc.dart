...
class GpsBloc extends Bloc<GpsEvent, GpsState> {
  ...
  GpsBloc() : super( const GpsState(isGpsEnabled: false, isGpsPermissionGranted: false, isScreenInitial: true) ) {
  ...
  Future<void> VuelvePantallaFrm() async {

    //state.isMuestraScreen = true;
